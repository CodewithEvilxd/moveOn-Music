    ...
    return (
        <footer className="py-5 backdrop-blur-3xl mt-8 px-6 md:px-20 lg:px-32">
            <div>
                ...
                <p className="text-xs text-muted-foreground">Made with Nextjs by <a className="underline hover:text-primary" href="https://github.com/codewithEvilxd">Evilxd</a> hosted on vercel.</p>
            </div>
            ...
            <div className="flex gap-3 mt-3">
                ...
                <Link target="_blank" className="text-sm opacity-80 font-light underline hover:opacity-100" href="https://instagram.com/codewithEvilxd">Instagram</Link>
            </div>
        </footer>
    )
}